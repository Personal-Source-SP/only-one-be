...
export class CreateStoreTables1764841263747 implements MigrationInterface {
    name = 'CreateStoreTables1764841263747';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "store_items" ADD CONSTRAINT "FK_e74a7a060ae79072d332cb72a86" FOREIGN KEY ("store_id") REFERENCES "stores"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
    }
